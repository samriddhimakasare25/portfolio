...
const content: contentSection[] = [
  {
    ...
    sectionHeader: {
      ...
      description: (
        <div>
          <span className="text-work_experience_orange">Full Stack Developer</span> with <span className="text-work_experience_orange">2 years</span> of experience in the software industry
        </div>
      ),
    },
        ...
        <Container>
          <div className="min-h-screen relative">
            <FadeIn className="max-w-5xl pt-40 md:pt-[20vh] 2xl:pt-[30vh]">
              ...
              <p className="max-w-3xl">19 year software engineer with a B.S. in Computer Science and minor in UX design with experience in Front-End and Back-End technologies.</p>
            </FadeIn>
