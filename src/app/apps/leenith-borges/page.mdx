...
export const appData = {
  industry: 'Technology',
  title: 'Safe Guard',
  description: 'SafeGuard is your key to a safer online environment. By prioritizing minority groups, while also empowering users to protect their mental well-being, we bring security to digital spaces.',
  image: leenithBorges,
  date: '2023-08',
  service: 'E-commerce',
